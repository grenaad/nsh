...
type hx =
  ...
  /// </summary>
  static member boost(value: bool) =
    prop.custom ("hx-boost", value.ToString().ToLower())
  ...
  /// </summary>
  static member disabled(value: bool) =
    prop.custom ("hx-disabled", value.ToString().ToLower())
  ...
  /// </summary>
  static member preserve(value: bool) =
    prop.custom ("hx-preserve", value.ToString().ToLower())
  ...
  /// </summary>
  static member pushUrl(value: bool) =
    prop.custom ("hx-push-url", value.ToString().ToLower())
  ...
  static member hyperscript(scripts: HyperscriptBuilder list) =
    let content =
      scripts |> List.map (fun script -> script.serialize ()) |> String.concat " "
  ...
  /// HyperScript content
  /// </summary>
  static member hyperscript(script: string list) =
    prop.custom ("_", String.concat " " script)
...
module hx =
  ...
  type swap =
    ...
    | ShowTop
    | ShowBottom
    | ShowDivTop of string
    | ShowDivBottom of string
    | ShowWindowTop
    | ShowWindowBottom
    | FocusScroll of bool
    ...
    member private this.str: string =
      ...
      | ShowDivTop s -> "show:" + s + ":top"
      | ShowDivBottom s -> "show:" + s + ":bottom"
      | ShowWindowTop -> "show:window:top"
    ...
    static member private swapType([<ParamArray>] args: swap[]) =
      let f =
        fun (str: string) (arg: swap) -> if str = "" then arg.str else str + " " + arg.str
